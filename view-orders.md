...
The listing order page shows a list view of all orders placed through your shop\(s\). From here you can access details of individual orders, edit orders and track the status of their payment and shipping. For details of how to create a new order see[here](http://openfoodnetwork.org/platform/user-guide/advanced-features/create-an-order/).
...
**Customer email:**The customer’s contact email. A full list of customer emails can be extracted in the ‘mailing list’[report](http://openfoodnetwork.org/platform/user-guide/producer-set-up-guide/reports/).
...
Check out [Pricing irregular, indivisible meat items](http://openfoodnetwork.org/platform/user-guide/advanced-features/pricing-irregular-indivisible-meat-items/) for more information about pricing products such as this.
