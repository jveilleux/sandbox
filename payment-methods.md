...
**Tags:** Using tag rules you can make certain payment methods available for specific cusotmers. See[here](https://openfoodnetwork.org/user-guide/advanced-features/customer-accounts-and-tagging/)for detail.
...
3. Click on ‘View API Signature’  and you will see the API details you’ll need to set up Paypal in OFN.
...
4. In OFN, make sure you are logged in as your Enterprise User. Go to an Enterprise and create a Payment Method. Select PayPal and fill in the details from the PayPal site.
